...
class ProjectWilder
{
    ...
    /**
     * @var
     * @ORM\ManyToOne (targetEntity="Project", inversedBy="projectWilders" , cascade={"persist"})
     */
    private $project;
    ...
    /**
     * @var
     * @ORM\ManyToOne (targetEntity="Wilder", inversedBy="projectWilders", cascade={"persist"})
     */
    private $wilder;
